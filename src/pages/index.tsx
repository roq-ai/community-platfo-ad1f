  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Community Platform: Empowering Users to Engage, Learn, and Connect through Blogs, Documentation, Videos, Real-time Streams, and Forums. Building Relationships, One Community at a Time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Community Platform: Empowering Users to Engage, Learn, and Connect through Blogs, Documentation, Videos, Real-time Streams, and Forums. Building Relationships, One Community at a Time.`}
            </Text>
            <Box
